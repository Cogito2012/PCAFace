...
%     data_train = squeeze(mean(data_train, 3));  % 32 x 32 x 28 transform into gray-scale images
    data_train = 0.229 * data_train(1:1024, :) + 0.587 * data_train(1025:2048, :) + 0.114 * data_train(2049:3072, :);
    ...
    data_test = 0.229 * data_test(1:1024, :) + 0.587 * data_test(1025:2048, :) + 0.114 * data_test(2049:3072, :);
